...
export const MOONS: Moon[] = [
  ...
  { id: 'phobos', name: 'Phobos', parentId: 'mars', radius: 11.3, orbitRadius: 9376, orbitalPeriod: 0.319, color: '#887766', irregular: true },
  { id: 'deimos', name: 'Deimos', parentId: 'mars', radius: 6.2, orbitRadius: 23460, orbitalPeriod: 1.263, color: '#998877', irregular: true },

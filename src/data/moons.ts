...
export const MOONS: Moon[] = [
  // Earth
  { id: 'luna', name: 'Moon', parentId: 'earth', radius: 1737, orbitRadius: 384400, orbitalPeriod: 27.32, color: '#aaaaaa', texture: '/nasa-assets/moon/face_0.png' },
  ...
  { id: 'io', name: 'Io', parentId: 'jupiter', radius: 1822, orbitRadius: 421700, orbitalPeriod: 1.769, color: '#ccaa44', texture: '/nasa-assets/io/face_0.png' },
  { id: 'europa', name: 'Europa', parentId: 'jupiter', radius: 1561, orbitRadius: 671034, orbitalPeriod: 3.551, color: '#ccbbaa', texture: '/nasa-assets/europa/face_0.png' },
  { id: 'ganymede', name: 'Ganymede', parentId: 'jupiter', radius: 2634, orbitRadius: 1070412, orbitalPeriod: 7.155, color: '#998877', texture: '/nasa-assets/ganymede/face_0.png' },
  { id: 'callisto', name: 'Callisto', parentId: 'jupiter', radius: 2410, orbitRadius: 1882709, orbitalPeriod: 16.689, color: '#665544', texture: '/nasa-assets/callisto/face_0.png' },
